...
class LLMProvider(BaseAIProvider):
    ...
    def __init__(self):
        ...
        if self.provider_type == "openai":
            ...
            self.model_path = os.getenv("LLAMA_CPP_MODEL_PATH", self.model_info.get("path", "/opt/models/L3.2-8X3B-MOE-Dark-Champion-Inst-18.4B-uncen-ablit_D_AU-Q4_k_m.gguf"))
