...
class Job(Base):
    ...
    gen_width = Column(Integer, default=lambda: int(os.getenv("GEN_WIDTH", 256)))
    gen_height = Column(Integer, default=lambda: int(os.getenv("GEN_HEIGHT", 448)))
    width = Column(Integer, default=lambda: int(os.getenv("GEN_WIDTH", 256)))
    height = Column(Integer, default=lambda: int(os.getenv("GEN_HEIGHT", 448)))
